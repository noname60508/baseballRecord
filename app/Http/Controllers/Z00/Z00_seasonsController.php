...
class Z00_seasonsController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        try {
            $table = Z00_seasons::select('id', 'name')
    ...
    public function update(Request $request, int $id)
    {
        ...
        try {
            ...
            return response()->apiResponse(Z00_seasons::find($id));
        } catch (\Throwable $e) {
            return response()->apiFail($e);
        }
    }
